...
func TestPublicKeyUnsafe(t *testing.T) {
	...
	require.Equal(t, "eb5ae98721034fef9cd7c4c63588d3b03feb5281b9d232cba34d6f3d71aee59211ffbfe1fe87",
		fmt.Sprintf("%extra", cdc.Amino.MustMarshalBinaryBare(priv.PubKey())),
	...
	require.Equal(t, "oceapub1addwnpepqd87l8xhcnrrtzxnkql7k55ph8fr9jarf4hn6udwukfprlalu8lgw0urza0",
		pubKeyAddr, "Is your device using test mnemonic: %s ?", testutil.TestMnemonic)

	addr := sdk.AccAddress(priv.PubKey().Address()).String()
	require.Equal(t, "ocea1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		addr, "Is your device using test mnemonic: %s ?", testutil.TestMnemonic)
}

func TestPublicKeyUnsafeHDPath(t *testing.T) {
	expectedAnswers := []string{
		"oceapub1addwnpepqd87l8xhcnrrtzxnkql7k55ph8fr9jarf4hn6udwukfprlalu8lgw0urza0",
		"oceapub1addwnpepqfsdqjr68h7wjg5wacksmqaypasnra232fkgu5sxdlnlu8j22ztxvlqvd65",
		"oceapub1addwnpepqw3xwqun6q43vtgw6p4qspq7srvxhcmvq4jrx5j5ma6xy3r7k6dtxmrkh3d",
		"oceapub1addwnpepqvez9lrp09g8w7gkv42y4yr5p6826cu28ydrhrujv862yf4njmqyyjr4pjs",
		"oceapub1addwnpepq06hw3enfrtmq8n67teytcmtnrgcr0yntmyt25kdukfjkerdc7lqg32rcz7",
		"oceapub1addwnpepqg3trf2gd0s2940nckrxherwqhgmm6xd5h4pcnrh4x7y35h6yafmcpk5qns",
		"oceapub1addwnpepqdm6rjpx6wsref8wjn7ym6ntejet430j4szpngfgc20caz83lu545vuv8hp",
		"oceapub1addwnpepqvdhtjzy2wf44dm03jxsketxc07vzqwvt3vawqqtljgsr9s7jvydjmt66ew",
		"oceapub1addwnpepqwystfpyxwcava7v3t7ndps5xzu6s553wxcxzmmnxevlzvwrlqpzz695nw9",
		"oceapub1addwnpepqw970u6gjqkccg9u3rfj99857wupj2z9fqfzy2w7e5dd7xn7kzzgkgqch0r",
	}
...
func TestPublicKeySafe(t *testing.T) {
	path := *hd.NewFundraiserParams(0, sdk.CoinType, 0)
	priv, addr, err := NewPrivKeySecp256k1(path, "ocea")
...
func TestPublicKeyHDPath(t *testing.T) {
	...
	expectedAddrs := []string{
		"ocea1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		"ocea19ewxwemt6uahejvwf44u7dh6tq859tkyvarh2q",
		"ocea1a07dzdjgjsntxpp75zg7cgatgq0udh3pcdcxm3",
		"ocea1qvw52lmn9gpvem8welghrkc52m3zczyhlqjsl7",
		"ocea17m78ka80fqkkw2c4ww0v4xm5nsu2drgrlm8mn2",
		"ocea1ferh9ll9c452d2p8k2v7heq084guygkn43up9e",
		"ocea10vf3sxmjg96rqq36axcphzfsl74dsntuehjlw5",
		"ocea1cq83av8cmnar79h0rg7duh9gnr7wkh228a7fxg",
		"ocea1dszhfrt226jy5rsre7e48vw9tgwe90uerfyefa",
		"ocea1734d7qsylzrdt05muhqqtpd90j8mp4y6rzch8l",
	}
