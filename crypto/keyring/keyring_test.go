...
import (
	...
	bip39 "github.com/ocea/go-bip39"
	"github.com/stretchr/testify/require"
	tmcrypto "github.com/tendermint/tendermint/crypto"

	"github.com/ocea/sdk/crypto"
...
func TestNewKeyring(t *testing.T) {
	...
	kr, err := New("ocea", BackendFile, dir, mockIn)
	require.NoError(t, err)

	nilKr, err := New("ocea", "fuzzy", dir, mockIn)
	require.Error(t, err)
	require.Nil(t, nilKr)
...
func TestKeyManagementKeyRing(t *testing.T) {
	...
	require.NoError(t, err)
	addr, err := sdk.AccAddressFromBech32("ocea1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t")
	require.NoError(t, err)
