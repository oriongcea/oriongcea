...
// where <bit-string> is a sequence of 'extra' (1) and '_' (0).
// The <bit-string> includes spaces and newlines to help people.
// For a simple sequence of 'extra' and '_' characters with no spaces or newlines,
...
// using a custom format: a string of '-' or 'extra' where 'extra' denotes the 1 bit.
