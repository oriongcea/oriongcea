...
// source: ocea/crypto/secp256k1/keys.proto
...
func init() {
	proto.RegisterType((*PubKey)(nil), "ocea.crypto.secp256k1.PubKey")
	proto.RegisterType((*PrivKey)(nil), "ocea.crypto.secp256k1.PrivKey")
}

func init() {
	proto.RegisterFile("ocea/crypto/secp256k1/keys.proto", fileDescriptor_e0835e68ebdcb224)
}
