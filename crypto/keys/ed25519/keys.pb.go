...
// source: ocea/crypto/ed25519/keys.proto
...
// the extra-coordinate. Otherwise the first byte is a 0x03.
// This prefix is followed with the extra-coordinate.
type PubKey struct {
...
func init() {
	proto.RegisterType((*PubKey)(nil), "ocea.crypto.ed25519.PubKey")
	proto.RegisterType((*PrivKey)(nil), "ocea.crypto.ed25519.PrivKey")
}

func init() { proto.RegisterFile("ocea/crypto/ed25519/keys.proto", fileDescriptor_48fe3336771e732d) }
