...
// source: ocea/base/store/v1beta1/commit_info.proto
...
func init() {
	proto.RegisterType((*CommitInfo)(nil), "ocea.base.store.v1beta1.CommitInfo")
	proto.RegisterType((*StoreInfo)(nil), "ocea.base.store.v1beta1.StoreInfo")
	proto.RegisterType((*CommitID)(nil), "ocea.base.store.v1beta1.CommitID")
}

func init() {
	proto.RegisterFile("ocea/base/store/v1beta1/commit_info.proto", fileDescriptor_83f4097f6265b52f)
}
