...
// CapabilityKey represent the OCEA SDK keys for object-capability
// generation in the IBC protocol as defined in https://github.com/ocea/ics/tree/master/spec/ics-005-port-allocation#data-structures
