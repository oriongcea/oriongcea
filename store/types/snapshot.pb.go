...
// source: ocea/base/store/v1beta1/snapshot.proto
...
func init() {
	proto.RegisterType((*SnapshotItem)(nil), "ocea.base.store.v1beta1.SnapshotItem")
	proto.RegisterType((*SnapshotStoreItem)(nil), "ocea.base.store.v1beta1.SnapshotStoreItem")
	proto.RegisterType((*SnapshotIAVLItem)(nil), "ocea.base.store.v1beta1.SnapshotIAVLItem")
}

func init() {
	proto.RegisterFile("ocea/base/store/v1beta1/snapshot.proto", fileDescriptor_9c55879db4cc4502)
}
