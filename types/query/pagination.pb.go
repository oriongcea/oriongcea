...
// source: ocea/base/query/v1beta1/pagination.proto
...
func init() {
	proto.RegisterType((*PageRequest)(nil), "ocea.base.query.v1beta1.PageRequest")
	proto.RegisterType((*PageResponse)(nil), "ocea.base.query.v1beta1.PageResponse")
}

func init() {
	proto.RegisterFile("ocea/base/query/v1beta1/pagination.proto", fileDescriptor_53d6d609fe6828af)
}
