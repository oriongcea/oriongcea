...
// source: ocea/tx/v1beta1/tx.proto
...
import (
	...
	types1 "github.com/ocea/sdk/crypto/types"
	github_com_ocea_ocea_sdk_types "github.com/ocea/sdk/types"
	types2 "github.com/ocea/sdk/types"
	signing "github.com/ocea/sdk/types/tx/signing"
...
type ModeInfo_Single struct {
	...
	Mode signing.SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=ocea.tx.signing.v1beta1.SignMode" json:"mode,omitempty"`
}
...
type Fee struct {
	...
	Amount github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"amount"`
...
func (m *Fee) GetAmount() github_com_ocea_ocea_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func init() {
	proto.RegisterType((*Tx)(nil), "ocea.tx.v1beta1.Tx")
	proto.RegisterType((*TxRaw)(nil), "ocea.tx.v1beta1.TxRaw")
	proto.RegisterType((*SignDoc)(nil), "ocea.tx.v1beta1.SignDoc")
	proto.RegisterType((*TxBody)(nil), "ocea.tx.v1beta1.TxBody")
	proto.RegisterType((*AuthInfo)(nil), "ocea.tx.v1beta1.AuthInfo")
	proto.RegisterType((*SignerInfo)(nil), "ocea.tx.v1beta1.SignerInfo")
	proto.RegisterType((*ModeInfo)(nil), "ocea.tx.v1beta1.ModeInfo")
	proto.RegisterType((*ModeInfo_Single)(nil), "ocea.tx.v1beta1.ModeInfo.Single")
	proto.RegisterType((*ModeInfo_Multi)(nil), "ocea.tx.v1beta1.ModeInfo.Multi")
	proto.RegisterType((*Fee)(nil), "ocea.tx.v1beta1.Fee")
}

func init() { proto.RegisterFile("ocea/tx/v1beta1/tx.proto", fileDescriptor_96d1575ffde80842) }
