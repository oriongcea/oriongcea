...
func TestBaseReq_Sanitize(t *testing.T) {
	...
	sanitized := rest.BaseReq{ChainID: "   test",
		Memo:          "memo     ",
		From:          " ocea1cq0sxam6x4l0sv9yz3a2vlqhdhvt2k6jtgcse0 ",
		Gas:           " ",
		GasAdjustment: "  0.3",
	}.Sanitize()
...
func TestBaseReq_ValidateBasic(t *testing.T) {
	fromAddr := "ocea1cq0sxam6x4l0sv9yz3a2vlqhdhvt2k6jtgcse0"
...
func TestProcessPostResponse(t *testing.T) {
	...
	cdc.RegisterConcrete(&mockAccount{}, "ocea-sdk/mockAccount", nil)
...
func TestPostProcessResponseBare(t *testing.T) {
	...
	t.Cleanup(func() { res.Body.Close() })
	require.Equal(t, "{\"extra\":\"10\",\"s\":\"test\"}", string(got))
