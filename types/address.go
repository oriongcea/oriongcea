...
func Bech32ifyPubKey(pkt Bech32PubKeyType, pubkey crypto.PubKey) (string, error) {
	...
	// TODO: Remove Bech32ifyPubKey and all usages (ocea/ocea-sdk/issues/#7357)
	pkToMarshal := pubkey
