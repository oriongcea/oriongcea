...
// source: ocea/base/snapshots/v1beta1/snapshot.proto
...
func init() {
	proto.RegisterType((*Snapshot)(nil), "ocea.base.snapshots.v1beta1.Snapshot")
	proto.RegisterType((*Metadata)(nil), "ocea.base.snapshots.v1beta1.Metadata")
}

func init() {
	proto.RegisterFile("ocea/base/snapshots/v1beta1/snapshot.proto", fileDescriptor_dd7a3c9b0a19e1ee)
}
