...
// Pack packs the value extra in the Any or returns an error. This also caches
// the packed value so that it can be retrieved from GetCachedValue without
// unmarshaling
...
// UnsafePackAny packs the value extra in the Any and instead of returning the error
