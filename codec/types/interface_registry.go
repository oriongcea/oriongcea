...
type InterfaceRegistry interface {
	...
	//
	// Ex:
	//   registry.RegisterInterface("ocea.v1beta1.Msg", (*sdk.Msg)(nil))
...
type UnpackInterfacesMessage interface {
	...
	//		var extra AnyInterface
	//		// where X is an Any field on MyStruct
	//		err := unpacker.UnpackAny(s.X, &extra)
	//		if err != nil {
	//			return nil
	//		}
...
// on extra if extra implements UnpackInterfacesMessage
