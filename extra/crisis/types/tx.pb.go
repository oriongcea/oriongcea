...
// source: ocea/crisis/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgVerifyInvariant)(nil), "ocea.crisis.v1beta1.MsgVerifyInvariant")
}

func init() { proto.RegisterFile("ocea/crisis/v1beta1/tx.proto", fileDescriptor_61276163172fe867) }
