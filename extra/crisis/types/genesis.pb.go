...
// source: ocea/crisis/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.crisis.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("ocea/crisis/v1beta1/genesis.proto", fileDescriptor_7a9c2781aa8a27ae)
}
