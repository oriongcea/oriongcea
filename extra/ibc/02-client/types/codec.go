...
func RegisterInterfaces(registry codectypes.InterfaceRegistry) {
	registry.RegisterInterface(
		"ocea_sdk.ibc.v1.client.ClientState",
		(*exported.ClientState)(nil),
	)
	registry.RegisterInterface(
		"ocea_sdk.ibc.v1.client.ConsensusState",
		(*exported.ConsensusState)(nil),
	)
	registry.RegisterInterface(
		"ocea_sdk.ibc.v1.client.Header",
		(*exported.Header)(nil),
	)
	registry.RegisterInterface(
		"ocea_sdk.ibc.v1.client.Height",
		(*exported.Height)(nil),
	)
	...
	registry.RegisterInterface(
		"ocea_sdk.ibc.v1.client.Misbehaviour",
...
var (
	// SubModuleCdc references the global extra/ibc/02-client module codec. Note, the codec should
	// ONLY be used in certain instances of tests and for JSON encoding.
	//
	// The actual codec used for serialization should be provided to extra/ibc/02-client and
