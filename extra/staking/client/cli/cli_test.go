...
import (
	...
	"github.com/ocea/sdk/extra/staking/client/cli"
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidator() {
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{"oceavaloper15jkng8hytwt22lllv6mw4k89qkqehtahd84ptu", fmt.Sprintf("--%s=json", tmcli.OutputFlag)},
			true,
		},
		{
			"happy case",
...
func (s *IntegrationTestSuite) TestNewCmdRedelegate() {
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				`oceavaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj`, // src-validator-addr
				val2.ValAddress.String(),                               // dst-validator-addr
