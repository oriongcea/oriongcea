...
// source: ocea/staking/v1beta1/genesis.proto
...
type GenesisState struct {
	...
	LastTotalPower github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,2,opt,name=last_total_power,json=lastTotalPower,proto3,customtype=github.com/ocea/sdk/types.Int" json:"last_total_power" yaml:"last_total_power"`
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.staking.v1beta1.GenesisState")
	proto.RegisterType((*LastValidatorPower)(nil), "ocea.staking.v1beta1.LastValidatorPower")
}

func init() {
	proto.RegisterFile("ocea/staking/v1beta1/genesis.proto", fileDescriptor_9b3dec8894f2831b)
}
