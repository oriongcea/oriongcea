...
// source: ocea/staking/v1beta1/tx.proto
...
type MsgCreateValidator struct {
	...
	MinSelfDelegation github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/ocea/sdk/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
...
type MsgEditValidator struct {
	...
	//
	// REF: #2373
	CommissionRate    *github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/ocea/sdk/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
func init() {
	proto.RegisterType((*MsgCreateValidator)(nil), "ocea.staking.v1beta1.MsgCreateValidator")
	proto.RegisterType((*MsgEditValidator)(nil), "ocea.staking.v1beta1.MsgEditValidator")
	proto.RegisterType((*MsgDelegate)(nil), "ocea.staking.v1beta1.MsgDelegate")
	proto.RegisterType((*MsgBeginRedelegate)(nil), "ocea.staking.v1beta1.MsgBeginRedelegate")
	proto.RegisterType((*MsgUndelegate)(nil), "ocea.staking.v1beta1.MsgUndelegate")
}

func init() { proto.RegisterFile("ocea/staking/v1beta1/tx.proto", fileDescriptor_0926ef28816b35ab) }
...
func (m *MsgEditValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_ocea_ocea_sdk_types.Dec
			m.CommissionRate = &v
		...
		case 4:
			...
			var v github_com_ocea_ocea_sdk_types.Int
