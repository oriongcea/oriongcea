...
func TestRandomizedGenState(t *testing.T) {
	...
	// check Delegations
	require.Equal(t, "ocea1tnh2q55v8wyygtt9srz5safamzdengsnqeycj3", stakingGenesis.Delegations[0].DelegatorAddress)
	require.Equal(t, "oceavaloper1tnh2q55v8wyygtt9srz5safamzdengsn9dsd7z", stakingGenesis.Delegations[0].ValidatorAddress)
	require.Equal(t, "1000.000000000000000000", stakingGenesis.Delegations[0].Shares.String())
	// check validators
	require.Equal(t, "oceavaloper1ghekyjucln7y67ntx7cf27m9dpuxxemnsvnaes", stakingGenesis.Validators[2].GetOperator().String())
	require.Equal(t, "oceavalconspub1zcjduepq280tm686ma80cva9z620dmknd9a858pd2zmq9ackfenfllecjxds0hg9n7", stakingGenesis.Validators[2].ConsensusPubkey)
