...
import (
	...
	"github.com/ocea/sdk/extra/staking/simulation"
...
func TestSimulateMsgCreateValidator(t *testing.T) {
	...
	require.Equal(t, "oceavalconspub1zcjduepq280tm686ma80cva9z620dmknd9a858pd2zmq9ackfenfllecjxds0hg9n7", msg.Pubkey)
	require.Equal(t, "ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.DelegatorAddress)
	require.Equal(t, "oceavaloper1ghekyjucln7y67ntx7cf27m9dpuxxemnsvnaes", msg.ValidatorAddress)
...
func TestSimulateMsgEditValidator(t *testing.T) {
	...
	require.Equal(t, "oceavaloper1tnh2q55v8wyygtt9srz5safamzdengsn9dsd7z", msg.ValidatorAddress)
	require.Len(t, futureOperations, 0)
}
...
func TestSimulateMsgUndelegate(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, "ocea1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.DelegatorAddress)
...
func TestSimulateMsgBeginRedelegate(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, "ocea12gwd9jchc69wck8dhstxgwz3z8qs8yv67ps8mu", msg.DelegatorAddress)
	require.Equal(t, "692322", msg.Amount.Amount.String())
	require.Equal(t, "stake", msg.Amount.Denom)
	require.Equal(t, types.TypeMsgBeginRedelegate, msg.Type())
	require.Equal(t, "oceavaloper1h6a7shta7jyc72hyznkys683z98z36e0zdk8g9", msg.ValidatorDstAddress)
	require.Equal(t, "oceavaloper17s94pzwhsn4ah25tec27w70n65h5t2scgxzkv2", msg.ValidatorSrcAddress)
	require.Len(t, futureOperations, 0)
