...
The ADR can be found here: https://github.com/ocea/sdk/blob/master/docs/architecture/adr-011-generalize-genesis-accounts.md.

Genesis accounts that existed in the genesis application state under `app_state.accounts`
now exists under the extra/auth module's genesis state under the `app_state.auth.accounts` key.
Migration can be performed via extra/auth/legacy/v0_38/migrate.go. In addition, because genesis
...
refer to https://github.com/ocea/gaia/pull/122.
*/
package genaccounts
