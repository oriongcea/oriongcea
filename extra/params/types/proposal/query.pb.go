...
// source: ocea/params/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "ocea.params.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "ocea.params.v1beta1.QueryParamsResponse")
}

func init() { proto.RegisterFile("ocea/params/v1beta1/query.proto", fileDescriptor_2b32979c1792ccc4) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ocea.params.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ocea.params.v1beta1.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ocea.params.v1beta1.Query",
	...
	Metadata: "ocea/params/v1beta1/query.proto",
}
