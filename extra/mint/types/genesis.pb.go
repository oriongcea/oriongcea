...
// source: ocea/mint/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.mint.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("ocea/mint/v1beta1/genesis.proto", fileDescriptor_0e215eb1d09cd648) }
