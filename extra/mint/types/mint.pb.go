...
// source: ocea/mint/v1beta1/mint.proto
...
type Minter struct {
	...
	AnnualProvisions github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,2,opt,name=annual_provisions,json=annualProvisions,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"annual_provisions" yaml:"annual_provisions"`
}
...
type Params struct {
	...
	InflationRateChange github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,2,opt,name=inflation_rate_change,json=inflationRateChange,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"inflation_rate_change" yaml:"inflation_rate_change"`
	// maximum inflation rate
	InflationMax github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,3,opt,name=inflation_max,json=inflationMax,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"inflation_max" yaml:"inflation_max"`
	// minimum inflation rate
	InflationMin github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,4,opt,name=inflation_min,json=inflationMin,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"inflation_min" yaml:"inflation_min"`
	// goal of percent bonded atoms
	GoalBonded github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,5,opt,name=goal_bonded,json=goalBonded,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"goal_bonded" yaml:"goal_bonded"`
...
func init() {
	proto.RegisterType((*Minter)(nil), "ocea.mint.v1beta1.Minter")
	proto.RegisterType((*Params)(nil), "ocea.mint.v1beta1.Params")
}

func init() { proto.RegisterFile("ocea/mint/v1beta1/mint.proto", fileDescriptor_2df116d183c1e223) }
