...
`x/upgrade` is an implementation of a OCEA SDK module that facilitates smoothly
upgrading a live OCEA chain to a new (breaking) software version. It accomplishes this by
