/*
Package upgrade provides a OCEA SDK module that can be used for smoothly upgrading a live OCEA chain to a
...
also potentially doing a backup. An example of such a daemon is https://github.com/regen-network/ocead/
...
We have deprecated calling out to scripts, instead with propose https://github.com/regen-network/ocead
...
specified here https://github.com/regen-network/ocead/blob/master/README.md#auto-download .
