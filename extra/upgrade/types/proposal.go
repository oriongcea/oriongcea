...
import (
	...
	gov "github.com/ocea/sdk/extra/gov/types"
)
...
func init() {
	...
	gov.RegisterProposalTypeCodec(&SoftwareUpgradeProposal{}, "ocea-sdk/SoftwareUpgradeProposal")
	gov.RegisterProposalType(ProposalTypeCancelSoftwareUpgrade)
	gov.RegisterProposalTypeCodec(&CancelSoftwareUpgradeProposal{}, "ocea-sdk/CancelSoftwareUpgradeProposal")
}
