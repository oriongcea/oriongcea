...
// source: ocea/upgrade/v1beta1/upgrade.proto
...
func init() {
	proto.RegisterType((*Plan)(nil), "ocea.upgrade.v1beta1.Plan")
	proto.RegisterType((*SoftwareUpgradeProposal)(nil), "ocea.upgrade.v1beta1.SoftwareUpgradeProposal")
	proto.RegisterType((*CancelSoftwareUpgradeProposal)(nil), "ocea.upgrade.v1beta1.CancelSoftwareUpgradeProposal")
}

func init() {
	proto.RegisterFile("ocea/upgrade/v1beta1/upgrade.proto", fileDescriptor_ccf2a7d4d7b48dca)
}
