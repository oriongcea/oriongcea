...
// source: ocea/capability/v1beta1/capability.proto
...
func init() {
	proto.RegisterType((*Capability)(nil), "ocea.capability.v1beta1.Capability")
	proto.RegisterType((*Owner)(nil), "ocea.capability.v1beta1.Owner")
	proto.RegisterType((*CapabilityOwners)(nil), "ocea.capability.v1beta1.CapabilityOwners")
}

func init() {
	proto.RegisterFile("ocea/capability/v1beta1/capability.proto", fileDescriptor_6308261edd8470a9)
}
