...
func TestNetGenesisState(t *testing.T) {
	...
	assert.NotNil(t, gen.GenTxs) // https://github.com/ocea/sdk/issues/5086
...
func TestGenesisStateFromGenFile(t *testing.T) {
	...
	require.Equal(t, "ocea106vrzv5xkheqhjm023pxcxlqmcjvuhtfyachz4", bankGenesis.Balances[0].GetAddress().String())
	require.Equal(t, "The native staking token of the OCEA Hub.", bankGenesis.DenomMetadata[0].GetDescription())
