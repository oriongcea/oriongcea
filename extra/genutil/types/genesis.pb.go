...
// source: ocea/genutil/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.genutil.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("ocea/genutil/v1beta1/genesis.proto", fileDescriptor_31771d25e8d8f90f)
}
