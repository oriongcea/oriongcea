...
// source: ocea/evidence/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSubmitEvidence)(nil), "ocea.evidence.v1beta1.MsgSubmitEvidence")
}

func init() { proto.RegisterFile("ocea/evidence/v1beta1/tx.proto", fileDescriptor_3e3242cb23c956e0) }
