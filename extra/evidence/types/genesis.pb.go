...
// source: ocea/evidence/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.evidence.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("ocea/evidence/v1beta1/genesis.proto", fileDescriptor_c610c52c26e0e202)
}
