...
// source: ocea/evidence/v1beta1/evidence.proto
...
func init() {
	proto.RegisterType((*Equivocation)(nil), "ocea.evidence.v1beta1.Equivocation")
}

func init() {
	proto.RegisterFile("ocea/evidence/v1beta1/evidence.proto", fileDescriptor_dd143e71a177f0dd)
}
