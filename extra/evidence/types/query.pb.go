...
// source: ocea/evidence/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryEvidenceRequest)(nil), "ocea.evidence.v1beta1.QueryEvidenceRequest")
	proto.RegisterType((*QueryEvidenceResponse)(nil), "ocea.evidence.v1beta1.QueryEvidenceResponse")
	proto.RegisterType((*QueryAllEvidenceRequest)(nil), "ocea.evidence.v1beta1.QueryAllEvidenceRequest")
	proto.RegisterType((*QueryAllEvidenceResponse)(nil), "ocea.evidence.v1beta1.QueryAllEvidenceResponse")
}

func init() {
	proto.RegisterFile("ocea/evidence/v1beta1/query.proto", fileDescriptor_07043de1a84d215a)
}
...
func (c *queryClient) Evidence(ctx context.Context, in *QueryEvidenceRequest, opts ...grpc.CallOption) (*QueryEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ocea.evidence.v1beta1.Query/Evidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllEvidence(ctx context.Context, in *QueryAllEvidenceRequest, opts ...grpc.CallOption) (*QueryAllEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ocea.evidence.v1beta1.Query/AllEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Evidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ocea.evidence.v1beta1.Query/Evidence",
	}
...
func _Query_AllEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ocea.evidence.v1beta1.Query/AllEvidence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ocea.evidence.v1beta1.Query",
	...
	Metadata: "ocea/evidence/v1beta1/query.proto",
}
