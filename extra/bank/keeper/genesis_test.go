...
func (suite *IntegrationTestSuite) getTestBalances() []types.Balance {
	addr2, _ := sdk.AccAddressFromBech32("ocea1f9xjhxm0plzrh9cskf4qee4pc2xwp0n0556gh0")
	addr1, _ := sdk.AccAddressFromBech32("ocea1fl48vsnmsdzcv85q5d2q4z5ajdha8yu34mf0eh")
