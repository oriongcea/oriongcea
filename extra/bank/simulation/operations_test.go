...
import (
	...
	"github.com/ocea/sdk/extra/bank/simulation"
...
func (suite *SimTestSuite) TestSimulateMsgSend() {
	...
	suite.Require().Equal("ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.FromAddress)
	suite.Require().Equal("ocea1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.ToAddress)
...
func (suite *SimTestSuite) TestSimulateMsgMultiSend() {
	...
	suite.Require().Equal("ocea1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.Inputs[1].Address)
	suite.Require().Equal("185121068stake", msg.Inputs[1].Coins.String())
	suite.Require().Len(msg.Outputs, 2)
	suite.Require().Equal("ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Outputs[1].Address)
