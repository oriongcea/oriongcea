...
// source: ocea/bank/v1beta1/bank.proto
...
type Input struct {
	...
	Coins   github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"coins"`
}
...
type Supply struct {
	Total github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"total"`
}
...
func init() {
	proto.RegisterType((*Params)(nil), "ocea.bank.v1beta1.Params")
	proto.RegisterType((*SendEnabled)(nil), "ocea.bank.v1beta1.SendEnabled")
	proto.RegisterType((*Input)(nil), "ocea.bank.v1beta1.Input")
	proto.RegisterType((*Output)(nil), "ocea.bank.v1beta1.Output")
	proto.RegisterType((*Supply)(nil), "ocea.bank.v1beta1.Supply")
	proto.RegisterType((*DenomUnit)(nil), "ocea.bank.v1beta1.DenomUnit")
	proto.RegisterType((*Metadata)(nil), "ocea.bank.v1beta1.Metadata")
}

func init() { proto.RegisterFile("ocea/bank/v1beta1/bank.proto", fileDescriptor_dd052eee12edf988) }
