...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"ocea-sdk/MsgSend","value":{"amount":[{"amount":"10","denom":"atom"}],"from_address":"ocea1d9h8qat57ljhcm","to_address":"ocea1da6hgur4wsmpnjyg"}}`
...
func TestMsgMultiSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"ocea-sdk/MsgMultiSend","value":{"inputs":[{"address":"ocea1d9h8qat57ljhcm","coins":[{"amount":"10","denom":"atom"}]}],"outputs":[{"address":"ocea1da6hgur4wsmpnjyg","coins":[{"amount":"10","denom":"atom"}]}]}}`
	require.Equal(t, expected, string(res))
}
