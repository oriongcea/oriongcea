...
// source: ocea/bank/v1beta1/genesis.proto
...
type GenesisState struct {
	...
	Supply github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,3,rep,name=supply,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"supply"`
...
func (m *GenesisState) GetSupply() github_com_ocea_ocea_sdk_types.Coins {
	if m != nil {
		return m.Supply
	}
	return nil
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.bank.v1beta1.GenesisState")
	proto.RegisterType((*Balance)(nil), "ocea.bank.v1beta1.Balance")
}

func init() { proto.RegisterFile("ocea/bank/v1beta1/genesis.proto", fileDescriptor_8f007de11b420c6e) }
