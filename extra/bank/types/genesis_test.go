...
func TestMarshalJSONMetaData(t *testing.T) {
	...
	testCases := []struct {
		...
		{"non-empty coins", []types.Metadata{{
			Description: "The native staking token of the OCEA Hub.",
			...
			`[{"description":"The native staking token of the OCEA Hub.","denom_units":[{"denom":"uatom","aliases":["microatom"]},{"denom":"matom","exponent":3,"aliases":["milliatom"]},{"denom":"atom","exponent":6}],"base":"uatom","display":"atom"}]`},
	}
