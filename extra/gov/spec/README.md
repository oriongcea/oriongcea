...
This paper specifies the Governance module of the OCEA-SDK, which was first
described in the [OCEA Whitepaper](https://ocea.network/about/whitepaper) in
June 2016.

The module enables OCEA-SDK based blockchain to support an on-chain governance
...
This module will be used in the OCEA Hub, the first Hub in the OCEA network.
