...
// source: ocea/gov/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.gov.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("ocea/gov/v1beta1/genesis.proto", fileDescriptor_43cd825e0fa7a627) }
