...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"ocea-sdk/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"stake"}],"depositor":"ocea1v9jxgu33kfsgr5","proposal_id":"0"}}`
...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	require.Equal(t,
		`{"type":"ocea-sdk/MsgSubmitProposal","value":{"content":{"type":"ocea-sdk/TextProposal","value":{"description":"abcd","title":"test"}},"initial_deposit":[]}}`,
		string(bz))
}
