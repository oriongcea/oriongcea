...
// source: ocea/gov/v1beta1/tx.proto
...
type MsgSubmitProposal struct {
	...
	InitialDeposit github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,2,rep,name=initial_deposit,json=initialDeposit,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"initial_deposit" yaml:"initial_deposit"`
...
func init() {
	proto.RegisterType((*MsgSubmitProposal)(nil), "ocea.gov.v1beta1.MsgSubmitProposal")
	proto.RegisterType((*MsgVote)(nil), "ocea.gov.v1beta1.MsgVote")
	proto.RegisterType((*MsgDeposit)(nil), "ocea.gov.v1beta1.MsgDeposit")
}

func init() { proto.RegisterFile("ocea/gov/v1beta1/tx.proto", fileDescriptor_3c053992595e3dce) }
