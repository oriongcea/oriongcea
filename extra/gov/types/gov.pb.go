...
// source: ocea/gov/v1beta1/gov.proto

package types

import (
	fmt "fmt"
	types1 "github.com/ocea/sdk/codec/types"
	...
	_ "github.com/ocea/sdk/ocea-proto"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type Deposit struct {
	...
	Amount     github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"amount"`
}
...
type Proposal struct {
	...
	Status           ProposalStatus                           `protobuf:"varint,3,opt,name=status,proto3,enum=ocea.gov.v1beta1.ProposalStatus" json:"status,omitempty" yaml:"proposal_status"`
	...
	TotalDeposit     github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,7,rep,name=total_deposit,json=totalDeposit,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"total_deposit" yaml:"total_deposit"`
...
type TallyResult struct {
	Yes        github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,1,opt,name=yes,proto3,customtype=github.com/ocea/sdk/types.Int" json:"yes"`
	Abstain    github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,2,opt,name=abstain,proto3,customtype=github.com/ocea/sdk/types.Int" json:"abstain"`
	No         github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,3,opt,name=no,proto3,customtype=github.com/ocea/sdk/types.Int" json:"no"`
	NoWithVeto github_com_ocea_ocea_sdk_types.Int `protobuf:"bytes,4,opt,name=no_with_veto,json=noWithVeto,proto3,customtype=github.com/ocea/sdk/types.Int" json:"no_with_veto" yaml:"no_with_veto"`
}
...
type Vote struct {
	...
	Option     VoteOption `protobuf:"varint,3,opt,name=option,proto3,enum=ocea.gov.v1beta1.VoteOption" json:"option,omitempty"`
}
...
type DepositParams struct {
	...
	MinDeposit github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,1,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"min_deposit,omitempty" yaml:"min_deposit"`
...
type TallyParams struct {
	...
	//  considered valid.
	Quorum github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,1,opt,name=quorum,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"quorum,omitempty"`
	//  Minimum proportion of Yes votes for proposal to pass. Default value: 0.5.
	Threshold github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,2,opt,name=threshold,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"threshold,omitempty"`
	//  Minimum value of Veto votes to Total votes ratio for proposal to be
	//  vetoed. Default value: 1/3.
	VetoThreshold github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,3,opt,name=veto_threshold,json=vetoThreshold,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"veto_threshold,omitempty" yaml:"veto_threshold"`
}
...
func init() {
	proto.RegisterEnum("ocea.gov.v1beta1.VoteOption", VoteOption_name, VoteOption_value)
	proto.RegisterEnum("ocea.gov.v1beta1.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*TextProposal)(nil), "ocea.gov.v1beta1.TextProposal")
	proto.RegisterType((*Deposit)(nil), "ocea.gov.v1beta1.Deposit")
	proto.RegisterType((*Proposal)(nil), "ocea.gov.v1beta1.Proposal")
	proto.RegisterType((*TallyResult)(nil), "ocea.gov.v1beta1.TallyResult")
	proto.RegisterType((*Vote)(nil), "ocea.gov.v1beta1.Vote")
	proto.RegisterType((*DepositParams)(nil), "ocea.gov.v1beta1.DepositParams")
	proto.RegisterType((*VotingParams)(nil), "ocea.gov.v1beta1.VotingParams")
	proto.RegisterType((*TallyParams)(nil), "ocea.gov.v1beta1.TallyParams")
}

func init() { proto.RegisterFile("ocea/gov/v1beta1/gov.proto", fileDescriptor_6e82113c1a9a4b7c) }
