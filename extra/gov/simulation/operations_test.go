...
import (
	...
	"github.com/ocea/sdk/extra/gov/simulation"
...
func TestSimulateMsgSubmitProposal(t *testing.T) {
	...
	require.Equal(t, "ocea1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.Proposer)
...
func TestSimulateMsgDeposit(t *testing.T) {
	...
	require.Equal(t, "ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Depositor)
...
func TestSimulateMsgVote(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, uint64(1), msg.ProposalId)
	require.Equal(t, "ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Voter)
