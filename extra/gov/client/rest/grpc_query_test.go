...
import (
	...
	"github.com/ocea/sdk/extra/gov/client/cli"
	govtestutil "github.com/ocea/sdk/extra/gov/client/testutil"
	"github.com/ocea/sdk/extra/gov/types"
)
...
func (s *IntegrationTestSuite) TestGetProposalGRPC() {
	...
	testCases := []struct {
		...
		{
			"empty proposal",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s", val.APIAddress, ""),
			true,
		},
		{
			"get non existing proposal",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s", val.APIAddress, "10"),
			true,
		},
		{
			"get proposal with id",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s", val.APIAddress, "1"),
			false,
		},
	}
...
func (s *IntegrationTestSuite) TestGetProposalsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals", val.APIAddress),
			map[string]string{
...
func (s *IntegrationTestSuite) TestGetProposalVoteGRPC() {
	...
	testCases := []struct {
		...
		{
			"empty proposal",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/votes/%s", val.APIAddress, "", voterAddressBase64),
			true,
		},
		{
			"get non existing proposal",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/votes/%s", val.APIAddress, "10", voterAddressBase64),
			true,
		},
		{
			"get proposal with wrong voter address",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/votes/%s", val.APIAddress, "1", "wrongVoterAddress"),
			true,
		},
		{
			"get proposal with id",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/votes/%s", val.APIAddress, "1", voterAddressBase64),
			false,
		},
	}
...
func (s *IntegrationTestSuite) TestGetProposalVotesGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/votes", val.APIAddress, ""),
			true,
		},
		{
			"get votes with valid id",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/votes", val.APIAddress, "1"),
			false,
		},
	}
...
func (s *IntegrationTestSuite) TestGetProposalDepositGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/deposits/%s", val.APIAddress, "", val.Address.String()),
			true,
		},
		{
			"get deposit of non existing proposal",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/deposits/%s", val.APIAddress, "10", val.Address.String()),
			true,
		},
		{
			"get deposit with wrong depositer address",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/deposits/%s", val.APIAddress, "1", "wrongDepositerAddress"),
			true,
		},
		{
			"get deposit valid request",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/deposits/%s", val.APIAddress, "1", val.Address.String()),
			false,
		},
	}
...
func (s *IntegrationTestSuite) TestGetProposalDepositsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/deposits", val.APIAddress, ""),
			true,
		},
		{
			"valid request",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/deposits", val.APIAddress, "1"),
			false,
		},
	}
...
func (s *IntegrationTestSuite) TestGetTallyGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/tally", val.APIAddress, ""),
			true,
		},
		{
			"get tally with non existing proposal",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/tally", val.APIAddress, "10"),
			true,
		},
		{
			"get tally valid request",
			fmt.Sprintf("%s/ocea/gov/v1beta1/proposals/%s/tally", val.APIAddress, "1"),
			false,
		},
	}
...
func (s *IntegrationTestSuite) TestGetParamsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/gov/v1beta1/params/%s", val.APIAddress, ""),
			true, nil, nil,
		},
		{
			"get deposit params",
			fmt.Sprintf("%s/ocea/gov/v1beta1/params/%s", val.APIAddress, types.ParamDeposit),
			false,
		...
		{
			"get vote params",
			fmt.Sprintf("%s/ocea/gov/v1beta1/params/%s", val.APIAddress, types.ParamVoting),
			false,
			&types.QueryParamsResponse{},
			&types.QueryParamsResponse{
		...
		{
			"get tally params",
			fmt.Sprintf("%s/ocea/gov/v1beta1/params/%s", val.APIAddress, types.ParamTallying),
			false,
			&types.QueryParamsResponse{},
			&types.QueryParamsResponse{
