...
// source: ocea/distribution/v1beta1/distribution.proto
...
type Params struct {
	CommunityTax        github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,1,opt,name=community_tax,json=communityTax,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"community_tax" yaml:"community_tax"`
	BaseProposerReward  github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_proposer_reward,json=baseProposerReward,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"base_proposer_reward" yaml:"base_proposer_reward"`
	BonusProposerReward github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,3,opt,name=bonus_proposer_reward,json=bonusProposerReward,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"bonus_proposer_reward" yaml:"bonus_proposer_reward"`
...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio github_com_ocea_ocea_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3,castrepeated=github.com/ocea/sdk/types.DecCoins" json:"cumulative_reward_ratio" yaml:"cumulative_reward_ratio"`
...
func (m *ValidatorHistoricalRewards) GetCumulativeRewardRatio() github_com_ocea_ocea_sdk_types.DecCoins {
	if m != nil {
...
func (m *ValidatorCurrentRewards) GetRewards() github_com_ocea_ocea_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type ValidatorAccumulatedCommission struct {
	Commission github_com_ocea_ocea_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=commission,proto3,castrepeated=github.com/ocea/sdk/types.DecCoins" json:"commission"`
}
...
func (m *ValidatorAccumulatedCommission) GetCommission() github_com_ocea_ocea_sdk_types.DecCoins {
	if m != nil {
		return m.Commission
	}
	return nil
...
type ValidatorOutstandingRewards struct {
	Rewards github_com_ocea_ocea_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/ocea/sdk/types.DecCoins" json:"rewards" yaml:"rewards"`
}
...
func (m *ValidatorOutstandingRewards) GetRewards() github_com_ocea_ocea_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type ValidatorSlashEvent struct {
	...
	Fraction        github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,2,opt,name=fraction,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"fraction"`
}
...
type FeePool struct {
	CommunityPool github_com_ocea_ocea_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3,castrepeated=github.com/ocea/sdk/types.DecCoins" json:"community_pool" yaml:"community_pool"`
}
...
func (m *FeePool) GetCommunityPool() github_com_ocea_ocea_sdk_types.DecCoins {
	if m != nil {
...
type CommunityPoolSpendProposal struct {
	...
	Amount      github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,4,rep,name=amount,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"amount"`
}
...
type DelegatorStartingInfo struct {
	...
	Stake          github_com_ocea_ocea_sdk_types.Dec `protobuf:"bytes,2,opt,name=stake,proto3,customtype=github.com/ocea/sdk/types.Dec" json:"stake" yaml:"stake"`
...
type DelegationDelegatorReward struct {
	...
	Reward           github_com_ocea_ocea_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reward,proto3,castrepeated=github.com/ocea/sdk/types.DecCoins" json:"reward"`
}
...
func init() {
	proto.RegisterType((*Params)(nil), "ocea.distribution.v1beta1.Params")
	proto.RegisterType((*ValidatorHistoricalRewards)(nil), "ocea.distribution.v1beta1.ValidatorHistoricalRewards")
	proto.RegisterType((*ValidatorCurrentRewards)(nil), "ocea.distribution.v1beta1.ValidatorCurrentRewards")
	proto.RegisterType((*ValidatorAccumulatedCommission)(nil), "ocea.distribution.v1beta1.ValidatorAccumulatedCommission")
	proto.RegisterType((*ValidatorOutstandingRewards)(nil), "ocea.distribution.v1beta1.ValidatorOutstandingRewards")
	proto.RegisterType((*ValidatorSlashEvent)(nil), "ocea.distribution.v1beta1.ValidatorSlashEvent")
	proto.RegisterType((*ValidatorSlashEvents)(nil), "ocea.distribution.v1beta1.ValidatorSlashEvents")
	proto.RegisterType((*FeePool)(nil), "ocea.distribution.v1beta1.FeePool")
	proto.RegisterType((*CommunityPoolSpendProposal)(nil), "ocea.distribution.v1beta1.CommunityPoolSpendProposal")
	proto.RegisterType((*DelegatorStartingInfo)(nil), "ocea.distribution.v1beta1.DelegatorStartingInfo")
	proto.RegisterType((*DelegationDelegatorReward)(nil), "ocea.distribution.v1beta1.DelegationDelegatorReward")
	proto.RegisterType((*CommunityPoolSpendProposalWithDeposit)(nil), "ocea.distribution.v1beta1.CommunityPoolSpendProposalWithDeposit")
}

func init() {
	proto.RegisterFile("ocea/distribution/v1beta1/distribution.proto", fileDescriptor_cd78a31ea281a992)
}
