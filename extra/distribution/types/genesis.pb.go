...
// source: ocea/distribution/v1beta1/genesis.proto
...
type ValidatorOutstandingRewardsRecord struct {
	...
	OutstandingRewards github_com_ocea_ocea_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=outstanding_rewards,json=outstandingRewards,proto3,castrepeated=github.com/ocea/sdk/types.DecCoins" json:"outstanding_rewards" yaml:"outstanding_rewards"`
}
...
func init() {
	proto.RegisterType((*DelegatorWithdrawInfo)(nil), "ocea.distribution.v1beta1.DelegatorWithdrawInfo")
	proto.RegisterType((*ValidatorOutstandingRewardsRecord)(nil), "ocea.distribution.v1beta1.ValidatorOutstandingRewardsRecord")
	proto.RegisterType((*ValidatorAccumulatedCommissionRecord)(nil), "ocea.distribution.v1beta1.ValidatorAccumulatedCommissionRecord")
	proto.RegisterType((*ValidatorHistoricalRewardsRecord)(nil), "ocea.distribution.v1beta1.ValidatorHistoricalRewardsRecord")
	proto.RegisterType((*ValidatorCurrentRewardsRecord)(nil), "ocea.distribution.v1beta1.ValidatorCurrentRewardsRecord")
	proto.RegisterType((*DelegatorStartingInfoRecord)(nil), "ocea.distribution.v1beta1.DelegatorStartingInfoRecord")
	proto.RegisterType((*ValidatorSlashEventRecord)(nil), "ocea.distribution.v1beta1.ValidatorSlashEventRecord")
	proto.RegisterType((*GenesisState)(nil), "ocea.distribution.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("ocea/distribution/v1beta1/genesis.proto", fileDescriptor_76eed0f9489db580)
}
