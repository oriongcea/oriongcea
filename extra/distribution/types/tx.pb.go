...
// source: ocea/distribution/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSetWithdrawAddress)(nil), "ocea.distribution.v1beta1.MsgSetWithdrawAddress")
	proto.RegisterType((*MsgWithdrawDelegatorReward)(nil), "ocea.distribution.v1beta1.MsgWithdrawDelegatorReward")
	proto.RegisterType((*MsgWithdrawValidatorCommission)(nil), "ocea.distribution.v1beta1.MsgWithdrawValidatorCommission")
	proto.RegisterType((*MsgFundCommunityPool)(nil), "ocea.distribution.v1beta1.MsgFundCommunityPool")
}

func init() {
	proto.RegisterFile("ocea/distribution/v1beta1/tx.proto", fileDescriptor_ed4f433d965e58ca)
}
