...
import (
	...
	"github.com/ocea/sdk/extra/distribution/simulation"
...
func (suite *SimTestSuite) TestSimulateMsgSetWithdrawAddress() {
	...
	suite.Require().Equal("ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.DelegatorAddress)
	suite.Require().Equal("ocea1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.WithdrawAddress)
...
func (suite *SimTestSuite) TestSimulateMsgWithdrawDelegatorReward() {
	...
	suite.Require().True(operationMsg.OK)
	suite.Require().Equal("oceavaloper1l4s054098kk9hmr5753c6k3m2kw65h686d3mhr", msg.ValidatorAddress)
	suite.Require().Equal("ocea1d6u7zhjwmsucs678d7qn95uqajd4ucl9jcjt26", msg.DelegatorAddress)
...
func (suite *SimTestSuite) testSimulateMsgWithdrawValidatorCommission(tokenName string) {
	...
	suite.Require().True(operationMsg.OK)
	suite.Require().Equal("oceavaloper1tnh2q55v8wyygtt9srz5safamzdengsn9dsd7z", msg.ValidatorAddress)
...
func (suite *SimTestSuite) TestSimulateMsgFundCommunityPool() {
	...
	suite.Require().Equal("ocea1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Depositor)
