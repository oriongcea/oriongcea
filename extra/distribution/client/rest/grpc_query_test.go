...
func (s *IntegrationTestSuite) TestQueryParamsGRPC() {
	...
	testCases := []struct {
		...
		{
			"gRPC request params",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/params", baseURL),
...
func (s *IntegrationTestSuite) TestQueryOutstandingRewardsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/validators/%s/outstanding_rewards", baseURL, "wrongAddress"),
			map[string]string{},
			true,
		...
		},
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/validators/%s/outstanding_rewards", baseURL, val.ValAddress.String()),
			map[string]string{
...
func (s *IntegrationTestSuite) TestQueryValidatorCommissionGRPC() {
	...
	testCases := []struct {
		...
		{
			"gRPC request params with wrong validator address",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/validators/%s/commission", baseURL, "wrongAddress"),
			map[string]string{},
			true,
		...
		{
			"gRPC request params valid address",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/validators/%s/commission", baseURL, val.ValAddress.String()),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
...
func (s *IntegrationTestSuite) TestQuerySlashesGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/validators/%s/slashes", baseURL, ""),
			true,
		...
		},
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/validators/%s/slashes?starting_height=%s&ending_height=%s", baseURL, val.ValAddress.String(), "-1", "3"),
			true,
			&types.QueryValidatorSlashesResponse{},
			nil,
		},
...
func (s *IntegrationTestSuite) TestQueryDelegatorRewardsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/rewards", baseUrl, "wrongDelegatorAddress"),
			map[string]string{},
			true,
		...
		{
			"valid request",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/rewards", baseUrl, val.Address.String()),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
		...
		},
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/rewards/%s", baseUrl, val.Address.String(), "wrongValAddress"),
			map[string]string{},
			true,
			&types.QueryDelegationTotalRewardsResponse{},
			nil,
		},
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/rewards/%s", baseUrl, val.Address.String(), val.ValAddress.String()),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
...
func (s *IntegrationTestSuite) TestQueryDelegatorValidatorsGRPC() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/validators", baseUrl, ""),
			true,
		...
		{
			"wrong delegator address",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/validators", baseUrl, "wrongDelegatorAddress"),
			true,
			&types.QueryDelegatorValidatorsResponse{},
			nil,
		},
		{
			"valid request",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/validators", baseUrl, val.Address.String()),
			false,
			&types.QueryDelegatorValidatorsResponse{},
			&types.QueryDelegatorValidatorsResponse{
...
func (s *IntegrationTestSuite) TestQueryWithdrawAddressGRPC() {
	...
	testCases := []struct {
		...
		{
			"empty delegator address",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/withdraw_address", baseUrl, ""),
			true,
		...
		{
			"wrong delegator address",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/withdraw_address", baseUrl, "wrongDelegatorAddress"),
			true,
			&types.QueryDelegatorWithdrawAddressResponse{},
			nil,
		},
		{
			"valid request",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/delegators/%s/withdraw_address", baseUrl, val.Address.String()),
			false,
			&types.QueryDelegatorWithdrawAddressResponse{},
			&types.QueryDelegatorWithdrawAddressResponse{
...
func (s *IntegrationTestSuite) TestQueryValidatorCommunityPoolGRPC() {
	...
	testCases := []struct {
		...
		{
			"gRPC request params with wrong validator address",
			fmt.Sprintf("%s/ocea/distribution/v1beta1/community_pool", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "2",
			},
			false,
