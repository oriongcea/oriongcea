...
// source: ocea/slashing/v1beta1/genesis.proto
...
type SigningInfo struct {
	...
	ValidatorSigningInfo types.ValidatorSigningInfo `protobuf:"bytes,2,opt,name=validator_signing_info,json=validatorSigningInfo,proto3" json:"validator_signing_info" yaml:"validator_signing_info"`
}
...
func (m *SigningInfo) GetValidatorSigningInfo() types.ValidatorSigningInfo {
	if m != nil {
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.slashing.v1beta1.GenesisState")
	proto.RegisterType((*SigningInfo)(nil), "ocea.slashing.v1beta1.SigningInfo")
	proto.RegisterType((*ValidatorMissedBlocks)(nil), "ocea.slashing.v1beta1.ValidatorMissedBlocks")
	proto.RegisterType((*MissedBlock)(nil), "ocea.slashing.v1beta1.MissedBlock")
}

func init() {
	proto.RegisterFile("ocea/slashing/v1beta1/genesis.proto", fileDescriptor_1923b9188b635394)
}
