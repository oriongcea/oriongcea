...
func NewGenesisState(
	params types.Params, signingInfos []SigningInfo, missedBlocks []ValidatorMissedBlocks,
) *GenesisState {
...
// DefaultGenesisState - default GenesisState used by OCEA Hub
