...
This section specifies the slashing module of the OCEA SDK, which implements functionality
first outlined in the [OCEA Whitepaper](https://ocea.network/about/whitepaper) in June 2016.

The slashing module enables OCEA SDK-based blockchains to disincentivize any attributable action
...
This module will be used by the OCEA Hub, the first hub in the OCEA ecosystem.
