...
// source: ocea/slashing/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "ocea.slashing.v1beta1.MsgUnjail")
}

func init() { proto.RegisterFile("ocea/slashing/v1beta1/tx.proto", fileDescriptor_3c5611c0c4a59d9d) }
