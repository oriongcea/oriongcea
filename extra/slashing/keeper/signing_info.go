...
func (k Keeper) GetValidatorMissedBlocks(ctx sdk.Context, address sdk.ConsAddress) []genesis.MissedBlock {
	missedBlocks := []genesis.MissedBlock{}
	k.IterateValidatorMissedBlockBitArray(ctx, address, func(index int64, missed bool) (stop bool) {
		missedBlocks = append(missedBlocks, genesis.NewMissedBlock(index, missed))
		return false
	})
