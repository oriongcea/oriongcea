...
// source: ocea/auth/v1beta1/auth.proto
...
func init() {
	proto.RegisterType((*BaseAccount)(nil), "ocea.auth.v1beta1.BaseAccount")
	proto.RegisterType((*ModuleAccount)(nil), "ocea.auth.v1beta1.ModuleAccount")
	proto.RegisterType((*Params)(nil), "ocea.auth.v1beta1.Params")
}

func init() { proto.RegisterFile("ocea/auth/v1beta1/auth.proto", fileDescriptor_7e1f7e915d020d2d) }
