...
// source: ocea/auth/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ocea.auth.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("ocea/auth/v1beta1/genesis.proto", fileDescriptor_d897ccbce9822332) }
