...
import (
	...
	codec2 "github.com/ocea/sdk/codec"
	...
	authcli "github.com/ocea/sdk/extra/auth/client/cli"
	authtest "github.com/ocea/sdk/extra/auth/client/testutil"
	authtypes "github.com/ocea/sdk/extra/auth/types"
	bankcli "github.com/ocea/sdk/extra/bank/client/testutil"
...
func TestGetBroadcastCommand_WithoutOfflineFlag(t *testing.T) {
	...
	from, err := sdk.AccAddressFromBech32("ocea1cxlt8kznps92fwu3j6npahx4mjfutydyene2qw")
	require.NoError(t, err)
	to, err := sdk.AccAddressFromBech32("ocea1cxlt8kznps92fwu3j6npahx4mjfutydyene2qw")
	require.NoError(t, err)
