...
// source: ocea/vesting/v1beta1/vesting.proto
...
import (
	...
	types "github.com/ocea/sdk/extra/auth/types"
...
type BaseVestingAccount struct {
	*types.BaseAccount `protobuf:"bytes,1,opt,name=base_account,json=baseAccount,proto3,embedded=base_account" json:"base_account,omitempty"`
	OriginalVesting    github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,2,rep,name=original_vesting,json=originalVesting,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"original_vesting" yaml:"original_vesting"`
	DelegatedFree      github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,3,rep,name=delegated_free,json=delegatedFree,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"delegated_free" yaml:"delegated_free"`
	DelegatedVesting   github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,4,rep,name=delegated_vesting,json=delegatedVesting,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"delegated_vesting" yaml:"delegated_vesting"`
...
type Period struct {
	...
	Amount github_com_ocea_ocea_sdk_types.Coins `protobuf:"bytes,2,rep,name=amount,proto3,castrepeated=github.com/ocea/sdk/types.Coins" json:"amount"`
}
...
func (m *Period) GetAmount() github_com_ocea_ocea_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func init() {
	proto.RegisterType((*BaseVestingAccount)(nil), "ocea.vesting.v1beta1.BaseVestingAccount")
	proto.RegisterType((*ContinuousVestingAccount)(nil), "ocea.vesting.v1beta1.ContinuousVestingAccount")
	proto.RegisterType((*DelayedVestingAccount)(nil), "ocea.vesting.v1beta1.DelayedVestingAccount")
	proto.RegisterType((*Period)(nil), "ocea.vesting.v1beta1.Period")
	proto.RegisterType((*PeriodicVestingAccount)(nil), "ocea.vesting.v1beta1.PeriodicVestingAccount")
}

func init() {
	proto.RegisterFile("ocea/vesting/v1beta1/vesting.proto", fileDescriptor_89e80273ca606d6e)
}
