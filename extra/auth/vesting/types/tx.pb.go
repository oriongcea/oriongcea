...
// source: ocea/vesting/v1beta1/tx.proto
...
func (m *MsgCreateVestingAccount) GetAmount() github_com_ocea_ocea_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func init() {
	proto.RegisterType((*MsgCreateVestingAccount)(nil), "ocea.vesting.v1beta1.MsgCreateVestingAccount")
}

func init() { proto.RegisterFile("ocea/vesting/v1beta1/tx.proto", fileDescriptor_5338ca97811f9792) }
