...
var (
	pattern_SimulateService_Simulate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 2}, []string{"ocea", "base", "simulate", "v1beta1"}, "", runtime.AssumeColonVerbOpt(true)))
)
