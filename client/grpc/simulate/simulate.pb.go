...
// source: ocea/base/simulate/v1beta1/simulate.proto
...
import (
	...
	tx "github.com/ocea/sdk/types/tx"
...
func init() {
	proto.RegisterType((*SimulateRequest)(nil), "ocea.base.simulate.v1beta1.SimulateRequest")
	proto.RegisterType((*SimulateResponse)(nil), "ocea.base.simulate.v1beta1.SimulateResponse")
}

func init() {
	proto.RegisterFile("ocea/base/simulate/v1beta1/simulate.proto", fileDescriptor_503c836d80bb2d47)
}
...
func (c *simulateServiceClient) Simulate(ctx context.Context, in *SimulateRequest, opts ...grpc.CallOption) (*SimulateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ocea.base.simulate.v1beta1.SimulateService/Simulate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SimulateService_Simulate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ocea.base.simulate.v1beta1.SimulateService/Simulate",
	}
...
var _SimulateService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ocea.base.simulate.v1beta1.SimulateService",
	...
	Metadata: "ocea/base/simulate/v1beta1/simulate.proto",
}
