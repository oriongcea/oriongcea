...
import (
	...
	github_com_regen_network_ocea_proto_test_iface "github.com/ocea/sdk/ocea-proto/test/iface"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type A struct {
	X int32 `protobuf:"varint,1,opt,name=extra,proto3" json:"extra,omitempty"`
}
...
type SomeImpl1 struct {
	X int64 `protobuf:"varint,1,opt,name=extra,proto3" json:"extra,omitempty"`
}
...
func (this *ABC) GetMsg() github_com_regen_network_ocea_proto_test_iface.Msg {
...
func (this *ABC) SetMsg(value github_com_regen_network_ocea_proto_test_iface.Msg) error {
	if value == nil {
		this.Sum = nil
		return nil
	}
...
func (this *ABCNonPointer) GetMsg() github_com_regen_network_ocea_proto_test_iface.Msg {
	if x := this.GetA(); x != nil {
		return x
	}
	if x := this.GetB(); x != nil {
...
func (this *ABCNonPointer) SetMsg(value github_com_regen_network_ocea_proto_test_iface.Msg) error {
	if value == nil {
		this.Sum = nil
		return nil
	}
