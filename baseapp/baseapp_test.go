...
import (
	...
	"github.com/ocea/sdk/snapshots"
	snapshottypes "github.com/ocea/sdk/snapshots/types"
...
func registerTestCodec(cdc *codec.LegacyAmino) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "ocea-sdk/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "ocea-sdk/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "ocea-sdk/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgKeyValue{}, "ocea-sdk/baseapp/msgKeyValue", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "ocea-sdk/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "ocea-sdk/baseapp/msgNoDecode", nil)
