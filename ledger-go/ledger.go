...
func ListDevices() {
	...
	for _, d := range devices {
		fmt.Printf("============ %s\n", d.Path)
		fmt.Printf("VendorID      : %extra\n", d.VendorID)
		fmt.Printf("ProductID     : %extra\n", d.ProductID)
		fmt.Printf("Release       : %extra\n", d.Release)
		fmt.Printf("Serial        : %extra\n", d.Serial)
		fmt.Printf("Manufacturer  : %s\n", d.Manufacturer)
		fmt.Printf("Product       : %s\n", d.Product)
		fmt.Printf("UsagePage     : %extra\n", d.UsagePage)
		fmt.Printf("Usage         : %extra\n", d.Usage)
		fmt.Printf("\n")
	}
}
